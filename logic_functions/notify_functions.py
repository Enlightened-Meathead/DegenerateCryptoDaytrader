...
def notify_email(subject, message, public_key=None):
    ...
    try:
        ...
        print(f"Error getting public key from creds file: {e}. If you didn't want to encrypt the email, ignore this "
              ...
              f"YOUR CONFIG FILE TO ULTIMATE FOR THIS TO WORK. This can be done by going to the directory the "
              f"config file is stored that has your public key string as a variable and open a python3 console, then "
